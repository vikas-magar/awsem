...
pub struct AppConfig {
    ...
    #[arg(long)] pub config_file: Option<String>,
    #[arg(long)] pub db_path: Option<String>,
    #[arg(long)] pub kubeconfig: Option<String>,
    #[arg(long)] pub k8s_namespace: Option<String>,
    #[arg(long)] pub rustfs_image: Option<String>,
    #[arg(long)] pub rustfs_pvc_size: Option<String>,
    #[arg(long)] pub s3_endpoint: Option<String>,
    #[arg(long)] pub no_s3: Option<bool>,
    #[arg(long)] pub no_emr: Option<bool>,
    #[arg(long)] pub no_lambda: Option<bool>,
    #[arg(long)] pub lambda_runtime_image: Option<String>,
    #[arg(long)] pub emr_spark_image: Option<String>,
    #[arg(long)] pub data_dir: Option<String>,
    #[arg(long)] pub log_dir: Option<String>,
    #[arg(long)] pub log_level: Option<String>,
    #[arg(long)] pub jwt_secret: Option<String>,
}
